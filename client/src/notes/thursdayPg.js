...
import { allThursday, thursdayNew } from "../notes/note-api";
...
class Thursday extends Component {
  ...
  clickSubmit = event => {
    ...
    thursdayNew(userId, token, this.noteData).then(data => {
