...
import { allSunday, sundayNew, sundayDelete } from "../notes/note-api";
...
class Sunday extends Component {
  ...
  clickSubmit = event => {
    ...
    sundayNew(userId, token, this.noteData).then(data => {
