...
import { allSaturday, saturdayNew } from "../notes/note-api";
...
class Saturday extends Component {
  ...
  clickSubmit = event => {
    ...
    saturdayNew(userId, token, this.noteData).then(data => {
