...
import { allWednesday, wednesdayNew } from "../notes/note-api";
...
class Wednesday extends Component {
  ...
  clickSubmit = event => {
    ...
    wednesdayNew(userId, token, this.noteData).then(data => {
